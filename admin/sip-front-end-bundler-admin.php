...
class Sip_Front_End_Bundler_WC_Admin {
          ...
          <div style="padding: 0; margin: 0; border: none; background: none;">
            <div  class="sip-notification-message">
              ...
              <div class="button_div">
                <a class="button" target="_blank" href="https://shopitpress.com/plugins/<?php echo SIP_FEBWC_PLUGIN_SLUG ; ?>/?utm_source=wordpress.org&amp;utm_medium=SIP-panel&amp;utm_content=v<?php echo SIP_FEBWC_PLUGIN_VERSION; ?>&amp;utm_campaign=<?php echo SIP_FEBWC_UTM_CAMPAIGN ; ?>"><?php _e( 'Learn More', 'front-end-bundler' ); ?></a>
              </div>
            </div>
          </div>
        </div>
  ...
  */
  ...
  <div class="sip-febwc-wrap wrap">
    ...
    <div class="sip-container">
      <h2 class="nav-tab-wrapper">
        <a class="nav-tab<?php if ( !isset( $_GET['action'] ) ) echo ' nav-tab-active'; ?>" href="admin.php?page=sip-bundler-settings"><?php _e( 'Help', 'front-end-bundler' ); ?></a>
      </h2>
      <?php
        if ( !isset( $_GET['action'] ) ) { 
          include("ui/help.php");
