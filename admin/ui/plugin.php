<?php 
    ...
    '1' => (object) array(
      ...
      'url'       => SIP_SPWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_FEBWC_VERSION .'&utm_campaign=' .SIP_FEBWC_UTM_CAMPAIGN,
      'title'     => SIP_SPWC_PLUGIN,
      'desc'      => __( 'Display real time proof of your sales and customers.<br>', 'front-end-bundler' ),
    ),
    '2' => (object) array(
      'image_url' => $src_image . 'icon-front-end-bundler.png',
      'url'       => SIP_FEBWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_FEBWC_VERSION .'&utm_campaign=' .SIP_FEBWC_UTM_CAMPAIGN,
      'title'     => SIP_FEBWC_PLUGIN,
      'desc'      => __( 'Bundle maker with real time offers.<br><br>', 'front-end-bundler' ),
    ),
    '3' => (object) array(
      'image_url' => $src_image . 'icon-reviews-shortcode.png',
      'url'       => SIP_RSWC_PLUGIN_URL . '?utm_source=wordpress.org&utm_medium=SIP-panel&utm_content=v'. SIP_FEBWC_VERSION .'&utm_campaign=' .SIP_FEBWC_UTM_CAMPAIGN,
